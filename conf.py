...
BLOG_AUTHOR = "Herodotus"  # (translatable)
BLOG_TITLE = "Church Culture"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.churchculture.net/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "herodotus@churchculture.net"
BLOG_DESCRIPTION = "Exploring the cultures - chronological, geographical, and denominational - of the Church."  # (translatable)
